      ...
      <div className="mt-4 flex items-end gap-3 flex-wrap">
        <label className="flex flex-col gap-1">
          ...
          <input
            ...
            className="bg-secondary text-foreground rounded-lg px-3 py-1.5 text-[14px] tabular-nums hairline focus:outline-none focus:ring-2 focus:ring-primary/40 w-44 disabled:opacity-50"
          />
        </label>
